...
**不碰 rotate**：方向由 C 写 `rotation.z`）；93 拖尾（每 2 帧一个，缩小淡出染红）；94 爆炸（0.4 → 2.4 放大淡出）；95 飞行粒子（每帧 2 颗，`%RANDF` 飘散 ±16 px，27 帧白 → 橙红）；96 落地火星（10 颗，飘 ±60 px 先快后慢，33 帧）；97 常态身体火焰（每帧 2 颗，在身体范围内随机起点、向上飘 30 px，27 帧）。2026-09-06 用户：粒子略大、寿命 +50％，常态也要有与火球相仿的粒子。
