...
| 断言 | th16 | th18 | 证据 |
| --- | :---: | :---: | --- |
| `MainMenu__on_tick` @0x44af80 按状态号 switch 分派 | ✅ | 🟡 | [th16/01 §1](th16/01-state-machine.md) |
| 状态转移统一走 `MainMenu__change_menu` @0x44a560 | ✅ | 🟡 | [th16/01 §2](th16/01-state-machine.md) |
| 状态枚举 → handler 全表（来自 on_tick switch） | ✅ | 🟡 | [th16/01 §3](th16/01-state-machine.md) |
| 角色/副季节选择写入全局，由 `player_shot_init` @0x440fb0 消费 | ✅ | ❌ | [th16/03](th16/03-character-subseason-sht-chain.md)；th18 无副季节 |
