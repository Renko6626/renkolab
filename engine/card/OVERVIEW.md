...
| 商店 offer = 随机 + 保证 混合（`AbilityShop__initialize` @0x4171B0），卡也可由道具直接掉落 | ❌ | ✅ | [th18/cards-04 §2,§2b](th18/cards-04-card-shop.md) |
| 关卡可用性由 `CardData__is_available_at_stage` @0x416E10 判定（**订正**了原 `_for_difficulty` 命名） | ❌ | ✅ | [th18/cards-04 §3](th18/cards-04-card-shop.md) |
